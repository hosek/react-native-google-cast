...
Pod::Spec.new do |s|
  ...
  s.homepage      = 'https://github.com/hosek/react-native-google-cast.git'
  s.license       = package['license']
  s.platform      = :ios, '9.0'

  s.source        = { :git => 'https://github.com/hosek/react-native-google-cast.git', :tag => s.version.to_s }
  ...
  s.subspec 'Default' do |ss|
    ...
    ss.dependency 'google-cast-sdk', '<= 4.4.0'
  end
